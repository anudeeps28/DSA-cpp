...
//   std::vector<Line>* ptrToVectorOfLines = &roads;
  ...
  return roads;
//   return ptrToVectorOfLines; // pointer will be in the heap even when the function is over, unlike stack which gets empty when function gets over
}
